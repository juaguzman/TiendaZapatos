...
static function listar_ventas()
{
    ...
    $result = $mysqli->query($consulta);
     ...
     echo "<tr align =center> <th colspan=12>Lista de Ventas Global</th> </tr>";
...
static function listar_ventas_sucursal($sucursal)
{
    ...
    $mysql = new conexion();
    $mysqli=$mysql->conctar();
    $consulta ="SELECT idfactura, fecha, valor_total, nomcomprador, cedulacomprador, vendedor_cedula, zapatos_idzapatos as 'idzapatos', zapatos.marca as 'marca', zapatos.modelo as 'modelo', zapatos.valor as 'valorUnid', vendedor.nombres as 'vendedor'"
